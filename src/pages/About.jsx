    ...
    return (
      <div>
        <section id="about-me">
            ...
            <p>
                Welcome to my site! My name is Mike Lind. I am a student developer based out of Minneapolis, where I'm currently enrolled in a full-stack coding bootcamp course through the University of Minnesota. I'm excited to share my work with you!
                <br />
                <br />
